	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-forest': 'linear-gradient(135deg, #1A2E0F 0%, #50AF33 100%)',
				'gradient-nature': 'linear-gradient(to right, #76b852, #8DC26F)',
			},
			fontFamily: {
			...
			boxShadow: {
				...
				'glow': '0 0 15px rgba(80, 175, 51, 0.5)',
				'inner-glow': 'inset 0 0 10px rgba(80, 175, 51, 0.3)',
			}
		}
	},
